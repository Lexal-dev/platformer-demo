...
export default function SonoreCredits() {
    ...
    return (
    <div className="w-full min-h-full text-white font-semibold p-10 overflow-y-auto">
        <button className="hover:text-green-300 cursor-pointer" onClick={handleBackClick}><FaBackward size={50}/></button>
        <div className="flex flex-col items-center">
            <p className="text-center text-3xl font-bold my-6 ">Effets Sonores</p>
            <div className="overflow-x-auto">
                <table className="table-auto border border-white text-left cursor-pointer">
                    <thead>
                    ...
                    {credits.map(([inGame, original, author, link]) => (
                        <tr key={inGame} className="hover:bg-slate-900 bg-white/20">
                            ...
                            <td className="border border-white p-2"><a href={link} target="_blank" rel="noopener noreferrer" className="hover:text-green-300">Source</a></td>
                        </tr>
                    ))}
                    </tbody>
                </table>
            ...
            <table className="table-auto  border border-white text-left cursor-pointer">
                ...
                <tbody>
                    <tr className="hover:bg-slate-900 bg-white/20">
                        ...
                        <td className="border border-white p-2"><a href="https://pixabay.com/users/sergequadrado-24990007/?utm_source=link-attribution&utm_medium=referral&utm_campaign=music&utm_content=275533" target="_blank" rel="noopener noreferrer" className="hover:text-green-300">  Source</a></td>
                    </tr>
                    <tr className="hover:bg-slate-900 bg-white/20">
                        ...
                        <td className="border border-white p-2"><a href="https://soundimage.org/" target="_blank" rel="noopener noreferrer" className="hover:text-green-300">  Source</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
